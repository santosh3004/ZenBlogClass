        ...
        <div class="card">
              ...
              <div class="card-body">
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-responsive table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                  <thead>
                  <tr>
                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Blog Id</th>
                  ...
                  <tbody>
                  <?php
           $userquery="Select * from sliders where deleted_at is not null";
          ...
          ?>
                  <tr class="odd">
                    <td class="dtr-control sorting_1" tabindex="0"><?php echo $users['blogs_id']; ?></td>
                    <td><?php echo $users['img']; ?></td>
                    <td><?php echo $users['order_id']; ?></td>
                    <td><?php echo $users['status']; ?></td>
                    <td>
                      
                      <a href="slidermanagement/softdelete.php?id=<?php echo $users['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                      <a href="slidermanagement/recycle.php?id=<?php echo $users['id']; ?>"><button type="button" class="btn btn-info">Recycle</button></a>
                  </td>
                  </tr>
                  <?php } ?>
                </tbody>
