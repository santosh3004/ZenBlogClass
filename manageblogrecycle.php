        ...
        <div class="card">
              ...
              <div class="card-body">
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-responsive table-hover dataTable dtr-inline" aria-describedby="example2_info">
                  ...
                  <tbody>
                  <?php
           $blogquery="Select * from blogs where deleted_at is not null";
          ...
          ?>
                  <tr class="odd">
                    ...
                    <td>
                      <a href="blogmanagement/delete.php?id=<?php echo $blog['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                      <a href="blogmanagement/recycle.php?id=<?php echo $blog['id']; ?>"><button type="button" class="btn btn-info">Restore</button></a>
                  </td>
                  </tr>
                  <?php } ?>
                </tbody>
